    ...
    if (cr.payment_screenshot) {
        screenshotHtml = `
            <div class="screenshot-box">
                <img src="../../${cr.payment_screenshot}" class="screenshot-thumb" alt="Payment SS" loading="lazy" style="cursor:pointer;" onclick="window.open('../../${cr.payment_screenshot}', '_blank')">
