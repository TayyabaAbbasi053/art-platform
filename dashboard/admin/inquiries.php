...
<body>
    ...
    <aside class="sidebar">
        ...
        <a href="artworks.php" class="nav-item"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="14.5" r="1.5"/></svg> Artworks<?php if ($sidebarHiddenArtworks > 0): ?><span class="badge"><?= $sidebarHiddenArtworks ?></span><?php endif; ?></a>
    ...
    Blog Posts
        ...
        <a href="messages.php" class="nav-item"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 4h16v13H4z"/><path d="M4 4l8 9 8-9"/></svg> Messages<?php if ($sidebarUnreadMessages > 0): ?><span class="badge amber"><?= $sidebarUnreadMessages ?></span><?php endif; ?></a>
