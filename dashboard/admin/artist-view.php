...
<header class="topbar">
    <div class="topbar-left">
        <a href="<?= htmlspecialchars($_GET['back'] ?? 'artists.php') ?>" class="back-link"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg> Artists</a>
...
<div id="nav-drawer">
  ...
  <a href="payments.php" class="d-link">Payments</a>
